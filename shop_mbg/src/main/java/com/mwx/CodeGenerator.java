...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("D:\\Development\\IDEA\\Idea_Projects\\WH_220518_Shop\\shop_parent\\shop_core\\shop_product\\src\\main\\java");
        globalConfig.setAuthor("Hojin");
        //生成后是否打开资源管理器
        ...
        dataSourceConfig.setUrl("jdbc:mysql://192.168.235.128:3306/shop_product?serverTimezone=GMT%2B8");
        ...
        packageConfig.setParent("com.mwx");
